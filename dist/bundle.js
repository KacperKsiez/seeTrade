...
var divNames={header:{navToggler:".main-header__btns-menu-toggler",nav:".main-header__nav"},first:{title:".first__title",subTitle:".first__subtitle",btnValuation:".first__btn-valuation"},numbers:{title:".our-numbers__title",subTitle:".our-numbers__subtitle",statName:".our-numbers__statName",statDesc:".our-numbers__statDesc"},aboutUs:{title:".about-us__title",subTitle:".about-us__subTitle"}},divNamesNoDots={header:{navOpened:"main-header__nav--opened",iconBurgerOpen:"icon-burger--opened"}};/* harmony default export */ const scripts_divNames = (divNames);
