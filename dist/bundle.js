...
var divNames={header:{navToggler:".main-header__btns-menu-toggler",nav:".main-header__nav"},first:{title:".first__title",subTitle:".first__subtitle",btnValuation:".first__btn-valuation"}},divNamesNoDots={header:{navOpened:"main-header__nav--opened",iconBurgerOpen:"icon-burger--opened"}};/* harmony default export */ const scripts_divNames = (divNames);
...
var timeline=gsapWithCSS.timeline({defaults:{duration:.7}}),first=scripts_divNames.first;timeline.from(first.title,{delay:.25,x:-300,opacity:0}),timeline.from(first.subTitle,{x:200,opacity:0});
