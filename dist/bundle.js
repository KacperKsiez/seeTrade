...
var divNames={header:{navToggler:".main-header__btns-menu-toggler",nav:".main-header__nav"},first:{title:".first__title",subTitle:".first__subtitle",btnValuation:".first__btn-valuation"},numbers:{title:".our-numbers__title",subTitle:".our-numbers__subtitle",statName:".our-numbers__statName",statDesc:".our-numbers__statDesc"},aboutUs:{title:".about-us__title",subTitle:".about-us__subTitle",slider:".about-us__group",tile:".about-us__tile"}},divNamesNoDots={header:{navOpened:"main-header__nav--opened",iconBurgerOpen:"icon-burger--opened"}};/* harmony default export */ const scripts_divNames = (divNames);
...
;// CONCATENATED MODULE: ./src/scripts/animations.ts
gsapWithCSS.registerPlugin(ScrollTrigger_ScrollTrigger);var first=scripts_divNames.first,numbers=scripts_divNames.numbers,aboutUs=scripts_divNames.aboutUs;function firstDivTimeline(){var a=gsapWithCSS.timeline({defaults:{duration:.7}});a.from(first.title,{delay:.4,x:-300,opacity:0}),a.from(first.subTitle,{x:200,opacity:0})}function numbersTimeline(){gsapWithCSS.from(numbers.title,{x:300,opacity:0,delay:.2,scrollTrigger:{trigger:numbers.subTitle}}),gsapWithCSS.from(numbers.subTitle,{x:-300,opacity:0,delay:.15,scrollTrigger:{trigger:numbers.subTitle}}),gsapWithCSS.from(numbers.statName,{x:-300,opacity:0,delay:.15,stagger:.2,scrollTrigger:{trigger:numbers.statDesc}}),gsapWithCSS.from(numbers.statDesc,{x:200,opacity:0,stagger:.25,scrollTrigger:{trigger:numbers.statDesc}})}function aboutUsTimeline(){var a={x:300,opacity:0,stagger:.4,delay:.3,scrollTrigger:{trigger:aboutUs.subTitle}},b={x:-300,opacity:0,delay:.3,stagger:.4,scrollTrigger:{trigger:aboutUs.subTitle}};gsapWithCSS.from(aboutUs.tile,a),gsapWithCSS.from(aboutUs.title,a),gsapWithCSS.from(aboutUs.subTitle,b)}firstDivTimeline(),numbersTimeline(),aboutUsTimeline();
;// CONCATENATED MODULE: ./src/scripts/aboutUsSlider.ts
var AboutUsSlider=/** @class */function(){function a(){var a=this;this.slider=document.querySelector(scripts_divNames.aboutUs.slider),this.isClicked=!1,this.startPosition=0,this.scrollLeft=0,this.handleMouseUp=function(){a.isClicked=!1},this.handleMouseLeave=function(){a.isClicked=!1},this.handleMouseDown=function(b){b.preventDefault(),a.isClicked=!0,a.startPosition=b.pageX-a.slider.offsetLeft,a.scrollLeft=a.slider.scrollLeft},this.handleMouseMove=function(b){if(b.preventDefault(),!!a.isClicked){var c=b.pageX-a.slider.offsetLeft,d=a.startPosition-c;a.slider.scrollLeft=a.scrollLeft+d}},this.initListeners()}return a.prototype.initListeners=function(){this.slider.addEventListener("mousedown",this.handleMouseDown),this.slider.addEventListener("mouseup",this.handleMouseUp),this.slider.addEventListener("mouseleave",this.handleMouseLeave),this.slider.addEventListener("mousemove",this.handleMouseMove)},a}(),a=new AboutUsSlider;
